...
import { BadgeCheck, Search, Users, TrendingUp, Sparkles } from 'lucide-react';
  ...
  return (
    <MainLayout>
      <div className="container max-w-2xl py-6 px-4 pb-24 lg:pb-8">
        ...
        {/* Tabs for Discover / Find Friends */}
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'discover' | 'friends')} className="mb-6">
